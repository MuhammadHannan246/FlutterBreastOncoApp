...
class OnBoardGoalSetupNineScreen extends StatefulWidget {
  const OnBoardGoalSetupNineScreen({super.key});
  static const routeName = '/onboard-goal-setup-nine';

  @override
  State<OnBoardGoalSetupNineScreen> createState() => _OnBoardGoalSetupNineScreenState();
}

class _OnBoardGoalSetupNineScreenState extends State<OnBoardGoalSetupNineScreen> {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0),
                        child: Text(
                          'Keeping track of things is a hassle. Let us make things easier for you - it\'s sort of our thing!',
                                ...
                                onPressed: selectedValue.isNotEmpty
                                    ? () {
                                        if (selectedValue == 'Yes') {
                                          Navigator.of(context).pushNamed(OnBoardReminderOneScreen.routeName);
                                        } else if (selectedValue == 'No') {
                                          Navigator.of(context).pushNamed(OnBoardGoalSetupTenScreen.routeName);
                                        }
                                      }
                                    : null,
