...
class OnBoardReminderFourScreen extends StatefulWidget {
  const OnBoardReminderFourScreen({super.key});
  static const routeName = '/onboard-reminder-four';

  @override
  State<OnBoardReminderFourScreen> createState() => _OnBoardReminderThreeScreenState();
}

class _OnBoardReminderThreeScreenState extends State<OnBoardReminderFourScreen> {
  @override
