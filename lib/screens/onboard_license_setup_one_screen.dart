...
class OnBoardLicenseSetupOneScreen extends StatefulWidget {
  const OnBoardLicenseSetupOneScreen({super.key});
  static const routeName = '/onboard-license-setup-one';

  @override
  State<OnBoardLicenseSetupOneScreen> createState() => _OnBoardLicenseSetupOneScreenState();
}

class _OnBoardLicenseSetupOneScreenState extends State<OnBoardLicenseSetupOneScreen> {
                          ...
                          Expanded(
                            child: ElevatedButton(
                              onPressed: selectedValue.isNotEmpty
                                  ? () {
                                      Navigator.of(context).pushNamed(OnBoardLicenseSetupTwoScreen.routeName);
                                    }
                                  : null,
