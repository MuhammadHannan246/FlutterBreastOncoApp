...
class OnBoardGoalSetupThreeScreen extends StatefulWidget {
  const OnBoardGoalSetupThreeScreen({super.key});
  static const routeName = '/onboard-goal-setup-three';

  @override
  State<OnBoardGoalSetupThreeScreen> createState() => _OnBoardGoalSetupThreeScreenState();
}

class _OnBoardGoalSetupThreeScreenState extends State<OnBoardGoalSetupThreeScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 16.0, horizontal: 16.0),
                      child: Text(
                        'Do you want us to auto create your daily, weekly and monthly goals for you?',
                              ...
                              onPressed: selectedValue.isNotEmpty
                                  ? () {
                                      if (selectedValue == 'Yes') {
                                        Navigator.of(context).pushNamed(OnBoardGoalSetupFourScreen.routeName);
                                      } else if (selectedValue == 'No') {
                                        Navigator.of(context).pushNamed(OnBoardGoalSetupFiveScreen.routeName);
                                      }
                                    }
                                  : null,
